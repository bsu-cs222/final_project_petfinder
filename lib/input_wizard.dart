...
class InputWizard{
  ...
  String organizeGenderInput(TextEditingController genderController){
    ...
    if(genderResult=='Error'){
      return ('Any'); //COME BACK because eventually we'll be running the method builder from here, WE CAN'T DO THAT NOW CAUSE DESTINY IS DOING METHOD CALLS SO UNTIL THEN WE RUN IT LIKE THIS -Sol
    }
    else{
    return(genderResult);}
